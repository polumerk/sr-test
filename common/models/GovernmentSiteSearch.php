...
/**
 * GovernmentSiteSearch represents the model behind the search form about `common\models\GovernmentSite`.
 */
class GovernmentSiteSearch extends GovernmentSite
{
    /**
     * @inheritdoc
     */
